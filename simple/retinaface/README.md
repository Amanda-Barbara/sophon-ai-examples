...
|       函数名称       | 运行次数 | 平均耗时(秒) | 最大耗时(秒) | 最小耗时(秒) |
+----------------------+----------+--------------+--------------+--------------+
|   predict_bmimage    |    1     |    0.051     |    0.051     |    0.051     |
| preprocess_with_bmcv |    1     |    0.008     |    0.008     |    0.008     |
|    infer_bmimage     |    1     |    0.006     |    0.006     |    0.006     |
|     postprocess      |    1     |    0.021     |    0.021     |    0.021     |
+----------------------+----------+--------------+--------------+--------------+
```

* self test with py_cpu_nms
```shell
+------------------------------------------------------------------------------+
|                          Running Time Cost Summary                           |
+----------------------+----------+--------------+--------------+--------------+
|       函数名称       | 运行次数 | 平均耗时(秒) | 最大耗时(秒) | 最小耗时(秒) |
+----------------------+----------+--------------+--------------+--------------+
|   predict_bmimage    |    1     |    0.052     |    0.052     |    0.052     |
| preprocess_with_bmcv |    1     |    0.008     |    0.008     |    0.008     |
|    infer_bmimage     |    1     |    0.006     |    0.006     |    0.006     |
|     postprocess      |    1     |    0.022     |    0.022     |    0.022     |
+----------------------+----------+--------------+--------------+--------------+
```
-  测试视频
``` shell
